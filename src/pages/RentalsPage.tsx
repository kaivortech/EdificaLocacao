                  ...
                  <td className="relative">
                    {deleteTarget === r.id ? (
                      ...
                      <div className="flex gap-2">
                        <button onClick={() => { const client = clients.find(c => c.id === r.clientId); gerarPDFContratoLocacao(r, client); }} className="btn-ghost text-primary hover:text-primary-600" title="Contrato">
