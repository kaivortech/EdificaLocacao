        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="relative flex items-center gap-2 transition-all duration-300">
              ...
              {isRegisterOpen && (
                <div className="absolute left-1/2 -translate-x-1/2 top-full mt-2 bg-secondary-800 rounded-2xl shadow-2xl border border-white/10 p-4 animate-fade-in z-50 w-[calc(100vw-32px)] sm:w-auto sm:min-w-[420px] max-w-[420px]">
