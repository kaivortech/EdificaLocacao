      ...
      `}>
        ...
        <nav className="flex-1 p-4 space-y-2">
          ...
          <NavLink to="/machines" className={({isActive}) => `sidebar-link group ${isActive ? 'active' : ''}`} onClick={onClose}>
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17l-4.11 4.11a1.5 1.5 0 01-2.12 0l-2.12-2.12a1.5 1.5 0 010-2.12l4.11-4.11m0 0l4.58-4.58a2.25 2.25 0 012.47-.53 2.25 2.25 0 011.06.53l2.12 2.12a2.25 2.25 0 01.53 2.47 2.25 2.25 0 01-.53 1.06l-4.58 4.58m-5.65-5.65l5.65 5.65" />
            </svg>
            Máquinas
          </NavLink>
